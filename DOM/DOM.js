...
for(const course of coursesAndDurationArray){
    ...
    block.innerText=`TITLE: ${course.title} | DURATION: ${course.monthDuration}`;
...
// Проітерувати масив, створиши для кожного об'єкту  масиву <div class='member'> та наповнити його данними з об'єкту.
...
for(const simpson of simpsons) {
    ...
    member.append(h1,age,info,photo);
